...
User query:
List all audiences used by live journeys with 'loyalty' in the journey name.

Selected metadata:
{
  "query": "List all audiences used by live journeys with 'loyalty' in the journey name.",
