...
User query:
What are the daily 'timeseries.ingestion.dataset.batchsuccess.count' values between '2026-02-01' and '2026-03-31'?

Selected metadata:
{
  "query": "What are the daily 'timeseries.ingestion.dataset.batchsuccess.count' values between '2026-02-01' and '2026-03-31'?",
  "selected_intent": "observability_daily_metric",
  "confidence": 0.95,
  "entities": [
    {
      "raw_text": "timeseries.ingestion.dataset.batchsuccess.count",
