...
User query:
List all audiences used by live journeys with 'paid' in the journey name.

Selected metadata:
{
  "query": "List all audiences used by live journeys with 'paid' in the journey name.",
  "selected_intent": "audiences_for_live_journey_keyword",
  "confidence": 0.95,
  "entities": [
    {
      "raw_text": "paid",
      "matched_table": "br_campaign_segment",
      "matched_column": "",
      "matched_value": "br_campaign_segment",
      "score": 67.5,
      "match_type": "fuzzy"
    }
  ],
