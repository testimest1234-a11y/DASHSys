...
User query:
What are the daily 'timeseries.ingestion.dataset.recordsuccess.count' values between '2026-03-15' and '2026-04-14'?

Selected metadata:
{
  "query": "What are the daily 'timeseries.ingestion.dataset.recordsuccess.count' values between '2026-03-15' and '2026-04-14'?",
  "selected_intent": "observability_daily_record_success",
  "confidence": 0.95,
  "entities": [
    {
      "raw_text": "timeseries.ingestion.dataset.recordsuccess.count",
  ...
  "selected_plan": {
    "id": "observability_daily_record_success",
    "intent": "observability_daily_record_success",
    "requires_sql": false,
    "requires_api": true,
    ...
    "required_entities": [],
    "description": "observability daily record success"
  },
  "router_evidence": [
