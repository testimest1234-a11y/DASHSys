...
User query:
For the audience 'Person: Birthday today', what is its profile count, is it batch or streaming, and how many audiences share the same rule definition?

Selected metadata:
{
  "query": "For the audience 'Person: Birthday today', what is its profile count, is it batch or streaming, and how many audiences share the same rule definition?",
