...
User query:
Is the audience 'Lives on East Coast' referenced in more than one journey simultaneously?

Selected metadata:
{
  "query": "Is the audience 'Lives on East Coast' referenced in more than one journey simultaneously?",
