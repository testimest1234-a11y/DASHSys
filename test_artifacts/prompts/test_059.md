...
User query:
Show ingestion record counts and batch success counts for the last 7 days.

Selected metadata:
{
  "query": "Show ingestion record counts and batch success counts for the last 7 days.",
