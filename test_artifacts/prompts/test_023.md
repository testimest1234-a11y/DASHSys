...
User query:
Is the audience 'Email Opt-In' referenced in more than one journey simultaneously?

Selected metadata:
{
  "query": "Is the audience 'Email Opt-In' referenced in more than one journey simultaneously?",
  "selected_intent": "audience_multi_journey_check",
  "confidence": 0.95,
  "entities": [
    {
      "raw_text": "Email Opt-In",
      "matched_table": "dim_segment",
      "matched_column": "NAME",
      "matched_value": "Email Opt-In",
      "score": 100.0,
      "match_type": "exact"
    }
  ],
