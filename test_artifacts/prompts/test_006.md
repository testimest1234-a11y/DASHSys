...
User query:
List all datasets that use the schema 'Journey Inbound'.

Selected metadata:
{
  "query": "List all datasets that use the schema 'Journey Inbound'.",
  "selected_intent": "datasets_for_schema",
  "confidence": 0.92,
  "entities": [
    {
      "raw_text": "Journey Inbound",
      "matched_table": "dim_collection",
      "matched_column": "NAME",
      "matched_value": "Journey Inbound",
      "score": 100.0,
      "match_type": "exact"
    }
  ],
